...
export const ARENAS: Arena[] = [
  {
    key: 'ground', name: 'Ground', from: 1, attempts: 5, fall: 10, clueFrom: 1,
    track: 'climbGround',
    background: '#EDE7DC', backgroundDeep: '#DFD7C8', surface: '#FBF9F5',
    text: '#2A251C', muted: '#6F6757', accent: '#8A7A5E',
  },
  {
    key: 'sky', name: 'Sky', from: 16, attempts: 5, fall: 15, clueFrom: 1,
    track: 'climbSky',
  ...
  },
  {
    ...
    key: 'thin', name: 'Thin air', from: 46, attempts: 6, fall: 32, clueFrom: 0,
    track: 'climbThin',
  ...
  {
    key: 'orbit', name: 'Orbit', from: 61, attempts: 6, fall: 45, clueFrom: 0,
    track: 'climbOrbit',
